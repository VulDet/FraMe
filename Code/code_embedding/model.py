...
class Model(nn.Module):
    ...
    def get_xcode_vec(self, source_ids):
        ...
        out = self.encoder(input_ids=source_ids, attention_mask=mask.unsqueeze(1) * mask.unsqueeze(2), output_hidden_states=True) #attention_mask=mask.unsqueeze(1) * mask.unsqueeze(2),
